...
$list = new LISTCONTROL($dbo,
    "SELECT cc.*, parent.name AS parent_name
     FROM content_categories cc
     LEFT JOIN content_categories parent ON parent.id = cc.parent_id
     WHERE cc.account_id = {$accountId} AND cc.property_id = {$propertyId}",
    [],
    [],
    [],
...
$list->SearchList($_GET, TRUE, FALSE, "cc.name", 1000);
...
<head>
    <meta charset="utf-8">
    <title><?php echo app::$project_name; ?> - Content categories</title>
    <?php include "_head.php"; ?>
    <script>
        function refresh() {
            window.location.href = "content_categories.php";
        }
    </script>
    <style>
